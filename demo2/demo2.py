...
ip_file_g = 'new_data_Set_2'
ip_file_c = 'data2'
ip_file_g2 = ip_file_g
ip_file_c2 = ip_file_c




####################---------- Specify files ----------####################
ip_file_g = open(ip_file_g+'.txt', 'r')
ip_file_c = open(ip_file_c+'.txt', 'r')
...
####################---------- Specify files ----------####################
#ip_file_g = raw_input('Enter ground truth file name:')
#ip_file_c = raw_input('Enter your clustering output file name:')
ip_file_g = open(str(ip_file_g2)+'.txt', 'r')
ip_file_c = open(str(ip_file_c2)+'.txt', 'r')
...
plt.savefig(str(ip_file_g2)+'.png', dpi=600)
...
plt.savefig(str(ip_file_c2)+'.png', dpi=600)
